...
public class FgTodayAppointments extends BaseFragment {

    private static final String TAG = "FgTodayAppointments";
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (getArguments() != null) {
            ...
            list = bundle.getParcelableArrayList(Constants.TODAYS);
        }
    }
